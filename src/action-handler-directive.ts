...
customElements.define('action-handler-countdown-timer', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-countdown-timer')) {
    return body.querySelector('action-handler-countdown-timer') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-countdown-timer');
